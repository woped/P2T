package de.dhbw.woped.process2text.pnmlProcessing.textGenerator;
...
import de.dhbw.woped.process2text.pnmlProcessing.contentDetermination.preprocessing.RigidStructurer;
import de.dhbw.woped.process2text.pnmlProcessing.dataModel.dsynt.DSynTSentence;
import de.dhbw.woped.process2text.pnmlProcessing.dataModel.pnmlReader.PNMLReader;
import de.dhbw.woped.process2text.pnmlProcessing.dataModel.pnmlReader.PetriNet.PetriNet;
import de.dhbw.woped.process2text.pnmlProcessing.dataModel.pnmlReader.PetriNetToProcessConverter;
import de.dhbw.woped.process2text.pnmlProcessing.sentencePlanning.DiscourseMarker;
import de.dhbw.woped.process2text.pnmlProcessing.sentencePlanning.ReferringExpressionGenerator;
import de.dhbw.woped.process2text.pnmlProcessing.sentencePlanning.SentenceAggregator;
import de.dhbw.woped.process2text.pnmlProcessing.sentenceRealization.SurfaceRealizer;
import de.dhbw.woped.process2text.pnmlProcessing.textPlanning.PlanningHelper;
import de.dhbw.woped.process2text.pnmlProcessing.textPlanning.TextPlanner;
