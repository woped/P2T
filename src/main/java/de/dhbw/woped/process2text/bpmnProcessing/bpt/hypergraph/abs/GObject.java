...
public abstract class GObject implements IGObject, Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof de.hpi.bpt.hypergraph.abs.GObject)) return false;
		
		return this.id.equals(((de.hpi.bpt.hypergraph.abs.GObject)obj).id);
	}
	...
	public Object clone() throws CloneNotSupportedException {
		de.hpi.bpt.hypergraph.abs.GObject clone = (de.hpi.bpt.hypergraph.abs.GObject) super.clone();
