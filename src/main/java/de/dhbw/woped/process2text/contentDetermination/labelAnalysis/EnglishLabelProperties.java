/* (C)2022 */
package de.dhbw.woped.process2text.contentDetermination.labelAnalysis;
...
public class EnglishLabelProperties {
  public static final String[] elements = {
    "until", "after", "on", "of", "by", "for", "from", "to", "at", "with", "w/o", "without", "in",
    "that", "using", "via", "during"
  };
  ...
  private int
      indexConjunctionSplit; // Index of conjunction in split label (index = 2 --> second word)
  ...
  public EnglishLabelProperties() {
    ...
    String[] elements = {
      "within", "into", "upon", "until", "on", "of", "for", "by", "from", "to", "at", "with", "w/o",
      "without", "in", "that", "using", "via", "during"
    };
