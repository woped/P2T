...
public class PlanningHelper {
     ...
     */
    static boolean isEndEvent(Object o, de.dhbw.woped.process2text.pnmlProcessing.dataModel.process.ProcessModel process) {
        if (o.getClass().toString().equals("class de.hpi.bpt.process.Event")) {
            de.dhbw.woped.process2text.pnmlProcessing.dataModel.process.Event event = process.getEvents().get(Integer.valueOf(((Event) o).getId()));
            return event.getType() == de.dhbw.woped.process2text.pnmlProcessing.dataModel.process.EventType.END_EVENT;
        }
        return false;
    }
